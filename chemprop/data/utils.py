...
def get_data(path: str,
    ...
    if args is not None:
        ...
        arr_vtf = arr_vtf if arr_vtf is not None else args.arr_vtf
    ...
    with open(path) as f:
        ...
        all_smiles, all_targets, all_rows, all_features, all_temps = [], [], [], [], []
        for i, row in enumerate(tqdm(reader)):
            ...
            #keep track of temperatures but keep them separate from other features
            if arr_vtf=='arr' or arr_vtf=='vtf':
        ...
        data = MoleculeDataset([
            ...
            ) for i, (smiles, targets,temps) in tqdm(enumerate(zip(all_smiles, all_targets, all_temps)),
